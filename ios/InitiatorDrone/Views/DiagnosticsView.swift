...
struct DiagnosticsView: View {
    ...
    private var streamSection: some View {
        Section {
            ...
            LabeledContent("Thermal rendered", value: String(format: "%.1f fps", connection.thermalRenderFPS))
            LabeledContent("Thermal frames dropped", value: "\(connection.droppedThermalFrames)")
