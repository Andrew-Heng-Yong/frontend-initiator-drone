...
/// Colour-map configuration shared by the depth and thermal renderers.
public struct ScalarColorMapSettings: Equatable, Sendable, Codable {
    ...
    /// Thermal defaults: a room-temperature-to-body-heat window.
    public static let thermalDefault = ScalarColorMapSettings(
        style: .ironbow,
        low: 18.0,
        high: 38.0,
        rangeMode: .autoSmoothed,
        reversed: false,
        opacity: 1.0,
        clampOutOfRange: true
    )
