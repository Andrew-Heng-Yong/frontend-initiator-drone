...
public enum RobotTopic: String, CaseIterable, Identifiable, Sendable {
    ...
    case thermalImage = "/thermal/cropped/image_raw"
    ...
    public var messageType: String {
        switch self {
        case .depthImage, .thermalImage: return "sensor_msgs/msg/Image"
    ...
    public var displayName: String {
        ...
        case .thermalImage: return "Thermal image"
    ...
    /// Image topics are throttled hard by default. The phone cannot usefully
    ...
    public var defaultThrottleMilliseconds: Int {
        switch self {
        case .depthImage, .thermalImage: return 66      // ~15 Hz ceiling
